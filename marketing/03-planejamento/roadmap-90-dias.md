...
| # | Entrega | Onde registrar | Status |
|---|---|---|---|
| 8 | Brand brief das três marcas fechado | `01-marcas/<marca>/brand-brief.md` | |
| 9 | ICP e personas validados | `01-marcas/<marca>/icp-e-personas.md` | |
| 10 | Funil mapeado com números reais | `01-marcas/<marca>/funil-e-jornada.md` | |
| 11 | Rastreamento e UTMs padronizados | `00-governanca/convencoes-de-nomenclatura.md` | |
| 12 | Painel de KPIs no ar | `02-compartilhado/biblioteca/fontes-de-dados.md` | |
| 13 | OKRs do trimestre definidos | `03-planejamento/okrs.md` | |
| 14 | Rituais rodando | `00-governanca/rituais-e-cadencia.md` | |

## Fase 3 — Execução (dias 61–90)

| # | Entrega | Onde registrar | Status |
|---|---|---|---|
| 15 | Calendário editorial por marca | `01-marcas/<marca>/calendario/` | |
| 16 | Primeira campanha estruturada | `01-marcas/<marca>/campanhas/` | |
